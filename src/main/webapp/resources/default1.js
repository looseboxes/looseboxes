...
var looseboxes = {
    ...
    function (k, v) {
        if(!k) return; 
//window.alert("#$set. innerHTML:"+k.innerHTML+", nodeValue:"+k.nodeValue+", value:"+k.value); 
        if(k.nodeValue !== null && typeof k.nodeValue !== 'undefined') {
            k.nodeValue = v;
        } else if(k.value !== null && typeof k.value !== 'undefined') {
            k.value = v;
        } else if(k.innerHTML !== null && typeof k.innerHTML !== 'undefined') {
            k.innerHTML = v;
        }
    },
    getNodeValue:
...
//window.alert("myAjax#get. Target element ID: " + idToUpdate);        
        myAjax.send("GET", idToSubmit, url, function(ajaxResponse){
...
//window.alert("myAjax#get$callback. Target element: " + mTarget + ", Response: " + ajaxResponse);
            if(mTarget && ajaxResponse) {
                var responseMsg = ajaxResponse.responseText;
//window.alert("myAjax#get$callback. Response text: " + responseMsg);
//window.alert("innerHTML: "+mTarget.innerHTML+", nodeValue: "+mTarget.nodeValue+", value: "+mTarget.value);
                looseboxes.setNodeValue(mTarget, responseMsg);
            }
        });
    },
    send: 
